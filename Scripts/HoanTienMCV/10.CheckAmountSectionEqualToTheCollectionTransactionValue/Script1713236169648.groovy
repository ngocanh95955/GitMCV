...
WebUI.setText(findTestObject('HoanTien/Page_LichSuGD/input_SoTien'), '50000')
...
WebUI.verifyElementClickable(findTestObject('HoanTien/button_ChonNganHangKhac'))

WebUI.verifyElementClickable(findTestObject('HoanTien/button_HUY'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('HoanTien/button_HoanTien'))
