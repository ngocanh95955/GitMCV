...
WebUI.setText(findTestObject('HoanTien/Page_LichSuGD/input_SoTien'), 'hai tram nghin dong')

WebUI.click(findTestObject('HoanTien/button_Kiemtrathongtin'))

WebUI.verifyElementText(findTestObject('HoanTien/MSG_SoTienYCLaKieuSo'), 'Số tiền yêu cầu là kiểu số')
