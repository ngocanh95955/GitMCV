...
WebUI.verifyElementText(findTestObject('HoanTien/Page_LichSuGD/Page_Lch s giao dch/Expected_TitleThongtinnganhang'), 'Thông tin ngân hàng')

WebUI.verifyElementClickable(findTestObject('HoanTien/icon_cancel'))

WebUI.verifyElementText(findTestObject('HoanTien/Expected_DropdownlistNganhang'), 'Ngân hàng')

WebUI.verifyElementText(findTestObject('HoanTien/Expected_DropdownlistLoaiTK'), 'Loại tài khoản')

WebUI.verifyElementText(findTestObject('HoanTien/Expected_TextboxSoTKNganHang'), 'Số tài khoản ngân hàng')

WebUI.verifyElementText(findTestObject('HoanTien/Expected_TextboxSotienGD'), 'Số tiền GD')

WebUI.verifyElementClickable(findTestObject('HoanTien/button_Kiemtrathongtin'))
