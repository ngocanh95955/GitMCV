...
WebUI.setText(findTestObject('HoanTien/Page_LichSuGD/input_STKNganhang'), '03874765655')

WebUI.setText(findTestObject('HoanTien/Page_LichSuGD/input_SoTien'), '10000')

WebUI.click(findTestObject('HoanTien/button_Kiemtrathongtin'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('HoanTien/MSG_ThongtinTKkhonghople'), 'Thông tin tài khoản ngân hàng không hợp lệ')
