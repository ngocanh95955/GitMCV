...
WebUI.setText(findTestObject('QlyGDchoduyet/input_maGD'), 'PD0JM0X4')
...
WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_MaGD'), 'PD0JM0X4')

WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_LoaiGD'), 'Rút tiền')

WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_Dichvu'), 'Chi hộ')

WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_Taikhoan'), '9Service')

//WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_sudungchiho'), 'Không dùng chi hộ')
WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_trangthai'), 'Đang xử lý')

WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_thoigian'), '13:44 10/09/2024')
