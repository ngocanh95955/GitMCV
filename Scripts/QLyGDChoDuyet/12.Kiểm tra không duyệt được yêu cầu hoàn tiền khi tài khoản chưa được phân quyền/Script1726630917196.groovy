...
WebUI.click(findTestObject('QlyGDchoduyet/chon_loaigiaodich_hoantien'))
...
WebUI.click(findTestObject('QlyGDchoduyet/chon_taikhoan9Service'))

WebUI.click(findTestObject('QlyGDchoduyet/button_timkiem'))

WebUI.click(findTestObject('QlyGDchoduyet/checkboxall'))

WebUI.verifyTextNotPresent('Duyệt hoàn tiền', false)
