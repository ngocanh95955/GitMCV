...
//Thêm 2 Gd hoàn auto  - trạng thái chờ VH1 duyệt ))
...
WebUI.setText(findTestObject('QlyGDchoduyet/input_thoigian'), '18/10/2024 - 18/10/2024')

WebUI.click(findTestObject('QlyGDchoduyet/button_timkiem'))

WebUI.verifyElementText(findTestObject('QlyGDchoduyet/Expect_trangthai_choVH1duyet'), 'Chờ vận hành 1 duyệt')
...
WebUI.click(findTestObject('QlyGDchoduyet/Button_OK'))
