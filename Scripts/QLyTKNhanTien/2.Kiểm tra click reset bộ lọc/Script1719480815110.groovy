...
WebUI.setText(findTestObject('QlyTKNHanTien/input_stk'), '1234566')

WebUI.click(findTestObject('QlyTKNHanTien/button_resetboloc'))

WebUI.verifyTextNotPresent('1234566', false)
