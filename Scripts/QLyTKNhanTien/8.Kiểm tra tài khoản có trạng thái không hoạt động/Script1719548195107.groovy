...
WebUI.click(findTestObject('QlyTKNHanTien/chon_nganhangVCB'))

WebUI.click(findTestObject('QlyTKNHanTien/input_tennganhang'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('QlyTKNHanTien/input_sotaikhoan'), '6868686868')
...
WebUI.verifyElementText(findTestObject('QlyTKNHanTien/Expected_trangthaikhonghoatdong'), 'Không hoạt động')
