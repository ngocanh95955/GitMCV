...
WebUI.setText(findTestObject('QlyNganHangChi/timkiem_stk'), '1023020330000')
...
WebUI.verifyElementText(findTestObject('QlyNganHangChi/Expect_Nganhang'), 'BIDV')

WebUI.verifyElementText(findTestObject('QlyNganHangChi/Expect_Tentaikhoan'), 'NGUYEN VAN A')

WebUI.verifyElementText(findTestObject('QlyNganHangChi/Expect_Sotaikhoan'), '1023020330000')

WebUI.verifyElementText(findTestObject('QlyNganHangChi/Expect_Thoigian'), '19:12 04/01/2024')
