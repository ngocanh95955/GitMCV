...
WebUI.setText(findTestObject('QlyNganHangChi/input_Sotaikhoan'), '777777')

WebUI.setText(findTestObject('QlyNganHangChi/input_Tentaikhoan'), 'TAI KHOAN CHAN')
...
WebUI.setText(findTestObject('QlyNganHangChi/timkiem_tentk'), 'TAI KHOAN CHAN')
...
WebUI.click(findTestObject('QlyNganHangChi/button_checkallSM'))
...
///Đăng nhap tk SM///
WebUI.callTestCase(findTestCase('Login/Login MCV 3'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('QlyNganHangChi/MCV_SoTK'), '777777')
