...
WebUI.setText(findTestObject('QlyNganHangChi/timkiem_tentk'), 'NANA TEST')

WebUI.click(findTestObject('QlyNganHangChi/Button_timkiem'))

WebUI.click(findTestObject('QlyNganHangChi/button_checkall'))

WebUI.click(findTestObject('QlyNganHangChi/Button_Xoataikhoan'))
