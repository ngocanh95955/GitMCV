...
WebUI.setText(findTestObject('QlyNganHangChi/input_Sotaikhoan'), '1234566')

WebUI.setText(findTestObject('QlyNganHangChi/input_Tentaikhoan'), 'TEST XOA')
...
WebUI.setText(findTestObject('QlyNganHangChi/timkiem_tentk'), 'TEST XOA')

WebUI.click(findTestObject('QlyNganHangChi/Button_timkiem'))

WebUI.click(findTestObject('QlyNganHangChi/button_xoa'))

WebUI.click(findTestObject('QlyNganHangChi/button_Dongy'))
