...
WebUI.click(findTestObject('Qly ty giá/Chon_vichuyen_VND'))
...
WebUI.setText(findTestObject('Qly ty giá/input_vinhan'), 'USD (USD)')

WebUI.click(findTestObject('Qly ty giá/Chon_vinhan_USD'))

WebUI.setText(findTestObject('Qly ty giá/input_sotienchuyen'), '100000')
...
WebUI.verifyElementText(findTestObject('Qly ty giá/Expect_tygiaquydoi_VNDsamgUSD'), '20,935 VND')
