...
WebUI.click(findTestObject('Qly ty giá/chon_vinguonUSD'))
...
WebUI.click(findTestObject('Qly ty giá/chon_vidichVND'))

WebUI.setText(findTestObject('Qly ty giá/input_sotien'), '10')

WebUI.verifyElementText(findTestObject('Qly ty giá/Expext_tygiaquydoi_USDsangVND'), 'Tỷ giá: 1 USD = 20,060 VND')

WebUI.verifyElementText(findTestObject('Qly ty giá/Expect_giatriquydoi_USDsangVND'), 'Giá trị quy đổi: 200,600 VND')
